...
public class DetCompras extends javax.swing.JFrame {
...
CruDCompra objCrud = new CruDCompra();
...
//        BigDecimal restaStock = new BigDecimal(restStock);
    ...
    CruDCompra objCBId = new CruDCompra();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetCompras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetCompras().setVisible(true);
            }
        });
    }
