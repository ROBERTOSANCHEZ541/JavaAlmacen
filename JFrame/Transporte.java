...
public class Transporte extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableTransp = new javax.swing.JTable();
        ...
        jTableTransp.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane1.setViewportView(jTableTransp);
...
CrudTransp objCrud = new CrudTransp();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        objCrud.Mostrar(jTableTransp);
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        String nombre = txtnombre.getText();
        String tipo = txtTipo.getText();
        Integer p_capacidadkg = Integer.parseInt(txtkg.getText());
        String p_numeroplaca = txtnp.getText();
        objCrud.Insertar(nombre, tipo, p_capacidadkg, p_numeroplaca);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Integer p_capacidadkg = Integer.parseInt(txtkg.getText());
        String p_numeroplaca = txtnp.getText();
        objCrud.Actualizar(id, nombre, tipo, p_capacidadkg, p_numeroplaca);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
 Integer id = Integer.parseInt(txtID.getText());
        objCrud.eliminarTransporte(id);
    ...
    private javax.swing.JTable jTableTransp;
